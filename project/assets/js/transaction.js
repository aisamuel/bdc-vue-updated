const transactionApp = new Vue({
    ...
    methods: {
        ...
        convertCurrencySell(toNaira = true) {
            ...
            //converting transaction from string to number
            ...
            if (toNaira) {
               ...
               //converting transaction from number to string with thousand comma seperator
           this.amountInCurrency = numeral(this.amountInCurrency).format('0,0[.]00');
           this.amountInNaira    = numeral(this.amountInNaira).format('0,0[.]00');
        ...
        payWithPaystack() {
            var amountInNaira    = numeral(this.amountInNaira).value(); 
            payWithPaystack(this.userProfile, amountInNaira, this.randomString, this.generateRandomString);
        },
